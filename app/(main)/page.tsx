...
export default function HomePage() {
  return (
    <div>
      <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center justify-between  ">
        ...
        <div className="w-full lg:w-1/2 space-y-6 text-center lg:text-left">
          ...
          <p className="text-lg text-gray-600 max-w-xl mx-auto lg:mx-0">
            Sustainable fuel solutions for kitchens, grills, and businesses —
            crafted with care.
          </p>
      ...
      <div className="absolute inset-0 -z-10 bg-[url('/images/smoke-texture.png')] bg-cover bg-center opacity-10" />
    </div>
  );
}
